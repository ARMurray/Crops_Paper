...
p <- ggboxplot(soybeans, x = "GSTempCategories", y = "YieldPercentChange",
               color = "GSpptCategories", palette =c("#FC4E07", "#00AFBB", "#E7B800"),
             add = "jitter", shape = "GSpptCategories",order = c("Below Normal", "Near Normal", "Above Normal"))
...
p2 <- ggpar(p, 
            ...
            subtitle = "",
            caption = "",
            xlab ="Growing Season Maximum Temperatures", 
...
q <- ggviolin(soybeans, x = "GSTempCategories", y = "YieldPercentChange",
...
q3 <- q2 + facet_wrap(. ~ State)

q3 + stat_compare_means(method = "anova", label = "p.format", label.y = 125) + stat_compare_means(label = "p.signif", method = "t.test", ref.group = "Near Normal")  
```
