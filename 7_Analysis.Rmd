...
#soybeans
fit <- lmList(Value ~ Year | FIPS , data=soybeans)
...
#cotton
fit <- lmList(Value ~ Year | FIPS , data=cotton)
...
#corn
fit <- lmList(Value ~ Year | FIPS , data=corn)
...
#peanuts
fit <- lmList(Value ~ Year | FIPS , data=peanuts)
