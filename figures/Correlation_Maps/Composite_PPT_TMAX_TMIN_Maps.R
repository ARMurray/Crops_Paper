...
cottonPlot <- ggplot(cottonSf)+
  ...
  theme(legend.position = 'none',
        ...
        axis.title.y=element_blank(),
        panel.background = element_blank(),
        plot.margin = margin(c(-2,0,-2,0), unit = "cm"))
...
soybeanPlot <- ggplot(soybeanSf)+
  ...
  theme(legend.position = 'none',
        ...
        axis.title.y=element_blank(),
        panel.background = element_blank(),
        plot.margin = margin(c(-4,0,0,0), unit = "cm"))
...
potatoPlot <- ggplot(potatoSf)+
  ...
  theme(legend.position = 'none',
        ...
        axis.title.y=element_blank(),
        panel.background = element_blank(),
        plot.margin = margin(c(-8,0,0,0), unit = "cm"))
...
lay <- rbind(c(1,6,11,NA),
             c(2,7,12,16),
             c(3,8,13,16),
             c(4,9,14,NA),
             c(5,10,15,NA))

tiff(here("figures/Correlation_Maps/Composite_PPT_TMAX_TMIN_Maps.tiff"), width = 20, height = 23, units = 'cm', res = 400)
grid.arrange(grobs = list(cornPPT,cottonPPT,peanutPPT,soybeanPPT,potatoPPT,
                          cornTMIN,cottonTMIN,peanutTMIN,soybeanTMIN,potatoTMIN,
                          cornTMAX,cottonTMAX,peanutTMAX,soybeanTMAX,potatoTMAX, legend),
             layout_matrix = lay)
dev.off()
