...
df <- read.csv(here("data/Crops_Final_Figs/Crops_Final_Figs/Tables1and2/StateCropsTMINCorrelation.csv"))%>%
...
tmin <- dfWide%>%
  ...
  tab_header("Minimum Temperature")%>%
...
# Export to pdf
gtsave(tmin,here("figures/tables/tmin_correlations.pdf"))